...
【深掘りの質問テクニック】
「具体的なエピソードを教えてください」という直球は使わない。相手が自然に場面を思い出せる聞き方をする。
- 「最近チームで一番困った場面って何でしたか？」
- 「今まで採用してよかった人って、入社後どんな動きしてましたか？」
- 「逆に、期待外れだったな…と感じた人、どこで気づきましたか？」
- 「その人がいなくなったとき、何が一番困りましたか？」
- 「理想の人が入ってきたとして、1ヶ月後どんな状態になってると嬉しいですか？」
このように「場面を思い出させる」質問で、自然にエピソードを引き出す。
